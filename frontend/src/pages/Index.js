            ...
            <div className='row'>
                ...
                <div className="col-sm-6 mb-3 mb-sm-0">
                    <section className='section-1'>
                        <h3 className="card-title" style={{textAlign:'center'}}><strong>Popular Skills</strong></h3>
        ...
        <div className="container">
            <div className="row">
                <div className="imgofabout col-lg-5">
                    <img className="imgofabout" src="img/about_img.jpg" alt="Web Development Training" />
                </div>
